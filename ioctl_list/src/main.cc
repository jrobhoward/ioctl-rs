...
#ifdef AUDITPIPE_PRESELECT_MODE_TRAIL
    constant(AUDITPIPE_PRESELECT_MODE_TRAIL);
#endif

#ifdef AUDITPIPE_PRESELECT_MODE_LOCAL
    constant(AUDITPIPE_PRESELECT_MODE_LOCAL);
#endif

#ifdef AUDITPIPE_GET_QLEN
    constant(AUDITPIPE_GET_QLEN);
#endif

#ifdef AUDITPIPE_GET_QLIMIT
    constant(AUDITPIPE_GET_QLIMIT);
#endif

#ifdef AUDITPIPE_SET_QLIMIT
    constant(AUDITPIPE_SET_QLIMIT);
#endif

#ifdef AUDITPIPE_GET_QLIMIT_MIN
    constant(AUDITPIPE_GET_QLIMIT_MIN);
#endif
...
#ifdef AUDITPIPE_GET_PRESELECT_FLAGS
    constant(AUDITPIPE_GET_PRESELECT_FLAGS);
#endif

#ifdef AUDITPIPE_SET_PRESELECT_FLAGS
    constant(AUDITPIPE_SET_PRESELECT_FLAGS);
#endif

#ifdef AUDITPIPE_GET_PRESELECT_NAFLAGS
    constant(AUDITPIPE_GET_PRESELECT_NAFLAGS);
#endif

#ifdef AUDITPIPE_SET_PRESELECT_NAFLAGS
    constant(AUDITPIPE_SET_PRESELECT_NAFLAGS);
#endif

#ifdef AUDITPIPE_GET_PRESELECT_AUID
    constant(AUDITPIPE_GET_PRESELECT_AUID);
#endif

#ifdef AUDITPIPE_SET_PRESELECT_AUID
    constant(AUDITPIPE_SET_PRESELECT_AUID);
#endif

#ifdef AUDITPIPE_DELETE_PRESELECT_AUID
    constant(AUDITPIPE_DELETE_PRESELECT_AUID);
#endif

#ifdef AUDITPIPE_FLUSH_PRESELECT_AUID
    constant(AUDITPIPE_FLUSH_PRESELECT_AUID);
#endif

#ifdef AUDITPIPE_GET_PRESELECT_MODE
    constant(AUDITPIPE_GET_PRESELECT_MODE);
#endif

#ifdef AUDITPIPE_SET_PRESELECT_MODE
    constant(AUDITPIPE_SET_PRESELECT_MODE);
#endif

#ifdef AUDITPIPE_FLUSH
    constant(AUDITPIPE_FLUSH);
#endif

#ifdef AUDITPIPE_GET_MAXAUDITDATA
    constant(AUDITPIPE_GET_MAXAUDITDATA);
#endif

#ifdef AUDITPIPE_GET_INSERTS
    constant(AUDITPIPE_GET_INSERTS);
#endif

#ifdef AUDITPIPE_GET_READS
    constant(AUDITPIPE_GET_READS);
#endif

#ifdef AUDITPIPE_GET_DROPS
    constant(AUDITPIPE_GET_DROPS);
#endif

#ifdef AUDITPIPE_GET_TRUNCATES
    constant(AUDITPIPE_GET_TRUNCATES);
#endif
